...
<!-- DataTable -->
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/datatable/media/css/jquery.dataTables.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/datatable/media/css/jquery.dataTables_themeroller.css" />" />
<script type="text/javascript" src="<c:url value="/resources/datatable/media/js/jquery.dataTables.min.js" />"></script>

<!-- Util -->
<script type="text/javascript" src="<c:url value="/resources/js/util.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/js/utilDialog.js" />"></script>
